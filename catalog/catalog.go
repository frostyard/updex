...
// definitions that happen to share a name or component.
...
// IsGeneratedFile reports whether the file at path exists and starts with
// the GeneratedMarker header.
