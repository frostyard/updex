...
- [ADR-0018 — Org-wide agent instruction and knowledge surfaces](https://github.com/frostyard/core/blob/main/docs/adr/0018-org-wide-agent-instruction-and-knowledge-surfaces.md) — yeti/, .knowledge/, .memory/ (note: this repo's symlink direction is drift, tracked in frostyard/core#1)
